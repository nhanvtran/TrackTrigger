...
xst -ifn xst.scr
move MezzClock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\MezzClock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc MezzClock_exdes.ucf MezzClock_exdes

echo 'Running map'
map -timing -pr b MezzClock_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm MezzClock_exdes -w routed.ncd routed.vhd
cd ..
